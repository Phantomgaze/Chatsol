import {
  ...
  export const useEmailMarketing = () => {
    ...
    const handleCreateEmailTemplate = async (values: FieldValues) => {
      try {
        setEditing(true)
    ...
    const onCreateEmailTemplate = SubmitEmail(handleCreateEmailTemplate)
    ...
    return {
      ...
      registerEmail,
      emailErrors,
      onCreateEmailTemplate: handleCreateEmailTemplate,
      editing,
      setValue,
    }
  }
